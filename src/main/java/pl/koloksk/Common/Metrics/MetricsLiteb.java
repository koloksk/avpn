package pl.koloksk.Common.Metrics;
...
public class MetricsLiteb {
    ...
    static {
        ...
        if (System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
            ...
            if (MetricsLiteb.class.getPackage().getName().equals(defaultPackage) || MetricsLiteb.class.getPackage().getName().equals(examplePackage)) {
     ...
     */
    public MetricsLiteb(Plugin plugin, int pluginId) {
        this.plugin = plugin;
